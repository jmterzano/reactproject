...
export default function FiltrarPeliculas() {
    ...
    const {register, handleSubmit, reset, formState: {isSubmitted}} = useForm<FormType>({
        defaultValues: valorInicial
    });

    const generos: Genero[] = [{id: 1, nombre: 'Accion'}, {id: 2, nombre: 'Comedia'}];
    ...
    return (
        <>
            ...
            className="row row-cols-lg-auto g-3 align-items-center">
                ...
                <div className="col-12">
                    <Boton disabled={isSubmitted} type="submit">{isSubmitted ? "Filtrando..." : "Filtrar"}</Boton>
